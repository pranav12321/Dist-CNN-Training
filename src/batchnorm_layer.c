...
void forward_batchnorm_layer(layer l, network net)
{
    ...
    if(net.train){
        ...
        normalize_cpu(l.output, l.mean, l.variance, 2, l.out_c, l.out_h*l.out_w);   
...
void forward_batchnorm_layer_distributed_ftp(ftp* ftp_params, layer l, network net)
{
    ...
    copy_cpu(l.outputs*l.batch, l.output, 1, l.x, 1);
    if(net.train){
        mean_cpu_distributed_ftp(ftp_params, l.output, l.batch, l.out_c, l.out_h*l.out_w, l.mean);
        variance_cpu_distributed_ftp(ftp_params, l.output, l.mean, l.batch, l.out_c, l.out_h*l.out_w, l.variance);
